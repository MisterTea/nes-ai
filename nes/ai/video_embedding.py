...
from transformers import VivitImageProcessor, VivitForVideoClassification, VivitConfig, EarlyStoppingCallback as TFEarlyStoppingCallback
...
assert videos[0].shape == (10, 224, 224, 3), f"Expected video shape (10, 224, 224, 3), got {videos[0].shape}"

image_processor = VivitImageProcessor.from_pretrained("google/vivit-b-16x2-kinetics400", do_resize=False, do_center_crop=False)
model = VivitForVideoClassification.from_pretrained("google/vivit-b-16x2-kinetics400", config=config, ignore_mismatched_sizes=True,)
