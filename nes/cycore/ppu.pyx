...
cdef class NESPPU:
    ...
    def copy_screen_buffer_to(self, dest, v_overscan=False, h_overscan=False):
        """
    ...
    cdef void render_visible_scanline(self):
        ...
        if 0 < self.pixel <= 256:  # pixels 1 - 256
            ...
            #print(self.transparent_color, bkg_pixel, self.ppu_scroll[PPU_SCROLL_X], self.ppu_mask, self.pixel, self.line, final_pixel, cmask, self.hex_palette[final_pixel & cmask])
    ...
    cdef int _get_bkg_pixel(self):
        ...
        #print("bg pixel: ", self._pattern_lo, self._pattern_hi, px, v, mask, self._palette[px>>3][v])
